...
forma = int("Insrisci la tua scelta:")

# Quadrato
if forma == 1:
    # Leggo la misura del lato e la converto in float
    lato = float("Inserisci la misura del lato:")
    perimetro = lato * 4
    area = lato**2
...
# Rettangolo
    ...
    base = float("Inserisci la misura della base:")
    altezza = float("Inserisci la misura della altezza:")
...
# Triangolo rettangolo
    ...
    c1 = float("Inserisci la misura del primo cateto:")
    c2 = float("Inserisci la misura del secondo cateto:")
    ...
    # Leggo la misura del lato e la converto in float
    raggio = float("Inserisci la misura del raggio:")
